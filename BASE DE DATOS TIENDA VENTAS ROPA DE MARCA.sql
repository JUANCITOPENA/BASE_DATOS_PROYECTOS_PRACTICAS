...
VALUES 
('Hamburguesa Clásica - McDonald''s', 1, 5.00),
('Cheeseburger - Burger King', 1, 6.00),
('Double Cheeseburger - Wendy''s', 1, 7.00),
('Pepperoni Pizza - Domino''s', 2, 12.00),
('Margherita Pizza - Pizza Hut', 2, 10.00),
('BBQ Chicken Pizza - Papa John''s', 2, 13.00),
('Hot Dog Clásico - Nathan''s', 3, 4.00),
('Chicago Style Hot Dog - Portillo''s', 3, 5.00),
('Taco de Carne - Taco Bell', 4, 2.50),
('Taco de Pollo - Chipotle', 4, 3.00),
('Sándwich de Pollo - Subway', 5, 7.50),
('Sándwich de Pavo - Panera Bread', 5, 8.00),
('Nuggets de Pollo - McDonald''s', 6, 4.50),
('Nuggets de Pollo - Chick-fil-A', 6, 5.00),
('Papas Fritas - Five Guys', 7, 3.00),
('Papas Fritas - Shake Shack', 7, 3.50),
('Coca-Cola - Coca-Cola', 8, 2.00),
('Pepsi - PepsiCo', 8, 2.00),
('Ensalada César - Panera Bread', 9, 6.00),
('Ensalada de Atún - Subway', 9, 7.00),
('Brownie - Domino''s', 10, 3.50),
('Tarta de Manzana - McDonald''s', 10, 2.50),
('Galleta de Chocolate - Subway', 10, 2.00),
('Churros - Taco Bell', 10, 3.00),
('Batido de Vainilla - Shake Shack', 8, 5.00),
('Limonada - Chick-fil-A', 8, 3.00);
GO
...
VALUES 
(1, 'https://example.com/imagenes/hamburguesa_clasica_mcdonalds.jpg'),
(2, 'https://example.com/imagenes/cheeseburger_burgerking.jpg'),
(3, 'https://example.com/imagenes/double_cheeseburger_wendys.jpg'),
(4, 'https://example.com/imagenes/pepperoni_pizza_dominos.jpg'),
(5, 'https://example.com/imagenes/margherita_pizza_pizzahut.jpg'),
(6, 'https://example.com/imagenes/bbq_chicken_pizza_papajohns.jpg'),
(7, 'https://example.com/imagenes/hot_dog_clasico_nathans.jpg'),
(8, 'https://example.com/imagenes/chicago_style_hot_dog_portillos.jpg'),
(9, 'https://example.com/imagenes/taco_de_carne_tacobell.jpg'),
(10, 'https://example.com/imagenes/taco_de_pollo_chipotle.jpg'),
(11, 'https://example.com/imagenes/sandwich_de_pollo_subway.jpg'),
(12, 'https://example.com/imagenes/sandwich_de_pavo_panerabread.jpg'),
(13, 'https://example.com/imagenes/nuggets_de_pollo_mcdonalds.jpg'),
(14, 'https://example.com/imagenes/nuggets_de_pollo_chickfila.jpg'),
(15, 'https://example.com/imagenes/papas_fritas_fiveguys.jpg'),
(16, 'https://example.com/imagenes/papas_fritas_shakeshack.jpg'),
(17, 'https://example.com/imagenes/coca_cola.jpg'),
(18, 'https://example.com/imagenes/pepsi.jpg'),
(19, 'https://example.com/imagenes/ensalada_cesar_panerabread.jpg'),
(20, 'https://example.com/imagenes/ensalada_atun_subway.jpg'),
(21, 'https://example.com/imagenes/brownie_dominos.jpg'),
(22, 'https://example.com/imagenes/tarta_manzana_mcdonalds.jpg'),
(23, 'https://example.com/imagenes/galleta_chocolate_subway.jpg'),
(24, 'https://example.com/imagenes/churros_tacobell.jpg'),
(25, 'https://example.com/imagenes/batido_vainilla_shakeshack.jpg');
GO
